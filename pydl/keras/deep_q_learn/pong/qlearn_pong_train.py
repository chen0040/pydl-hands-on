...
import pydl.keras.deep_q_learn.pong.pong_wrapped_game as pong_wrapped_game
...
def get_next_batch(experience, model, num_actions, gamma, batch_size):
    ...
    for i in range(len(batch)):
        ...
        if game_over:
            ...
            Y[i, a_t] = r_t + gamma * Q_sa # note that this assumes alpha the learning rate is 1
    return X, Y
...
# train network
game = pong_wrapped_game.MyWrappedGame()
